...
Revision ID: 8856b4361081
Revises: 
Create Date: 2025-11-15 16:33:49.762394
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('provider', 'control_id', name=op.f('uq_policy_provider_control'))
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('provider', 'external_id', name=op.f('uq_provider_account'))
    )
